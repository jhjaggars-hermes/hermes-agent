    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            async def on_message(message: DiscordMessage):
                ...
                _accepted_role_mention = self._has_accepted_role_mention(message)
                if not isinstance(message.channel, discord.DMChannel) and (
                    message.mentions or _raw_self_mention or _accepted_role_mention
                ):
                    _self_mentioned = _raw_self_mention or _accepted_role_mention
